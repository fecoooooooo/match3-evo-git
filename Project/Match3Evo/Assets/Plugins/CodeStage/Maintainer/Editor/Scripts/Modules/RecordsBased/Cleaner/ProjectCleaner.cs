...
namespace CodeStage.Maintainer.Cleaner
{
	...
	public static class ProjectCleaner
	{
		...
		private static bool ScanProjectFiles(ICollection<CleanerRecord> results, bool showProgress = true)
		{
			...
			{
				results.Add(CleanerErrorRecord.Create("Please add scenes you are using to the build settings\n" +
				                                      "or configure used scenes manually at the Filters > Scenes Ignores tab."));
				return false;
			}
